...
def render_image(renderer, mesh, obj_filename, azim, elev,path):
    """
...
def compile_all_steps(image_size, dist, device, elev, azim, obj_filename,path):
    """
    ...
    render_image(renderer, mesh, obj_filename, azim, elev,path)
    return None


def main():
     [compile_all_steps(params.image_size, params.camera_dist, device, x, y,
                        params.obj_filename,params.path)
